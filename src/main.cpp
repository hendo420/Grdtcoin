...
uint256 hashGenesisBlock("0x813a1aaa1cb930adc774f6bb46bb0c39f72ac50e891670524f3fc85c4cd72488");
...
const string strMessageMagic = "grdtcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 10 * 60; // grdtcoin: 10 minutes; 
static const int64 nTargetSpacing = 30; // grdtcoin: 30 sec blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal grdtcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "grdtcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf08d259f96babfd9f80812e2e3d23be45ffcbab1e30bb9167fad5bcbe0c4540f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1388189875; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2614110;

        if (fTestNet)
        {
            block.nTime    = 1388168322;
            block.nNonce   = 1948329;
        }
